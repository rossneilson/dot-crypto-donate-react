...
const DonateButton = _styledComponents.default.button(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  transition: 0.2s;\n  height: 50px;\n  background-color: ", ";\n  color: ", ";\n  justify-content: space-around;\n  font-size: ", ";\n  font-weight: 500;\n  border: none;\n  cursor: pointer;\n  border-radius: 5px;\n  margin: auto;\n  border-radius: 0px 5px 5px 0px;\n  width: 30%;\n  &:hover {\n    background-color: ", ";\n  }\n  &:focus {\n    background-color: ", ";\n  }\n"])), props => props.colors.button, props => props.colors.text, props => props.theme.fontSizes.r, props => props.theme.colors.buttonHoverColor, props => props.theme.colors.buttonHoverColor);
